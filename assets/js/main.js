...
(function () {
  ...
  function initializeCodeFences() {
    ...
    highlights.forEach((highlight) => {
      ...
      // Real, focusable copy button (keyboard & screen-reader accessible)
      ...
      copyBtn.addEventListener("click", async () => {
        ...
        // Strip Chroma line-number spans instead of regex-editing the text,
        // so code lines that start with digits are preserved.
