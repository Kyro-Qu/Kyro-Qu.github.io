...
---
# Claude Code 更高权限，不用反复点确认

## 权限模式（Mode）

![image-20260523005541789](/images/posts/claude-code-permissions/image-20260523005541789.png)
...
![image-20260523005813904](/images/posts/claude-code-permissions/image-20260523005813904.png)
...
![image-20260523005719777](/images/posts/claude-code-permissions/image-20260523005719777.png)

#### **完成**：

关闭设置页面，回到你的代码窗口。此时再去点击那个 Mode 菜单，底下的 `Bypass permissions` 就已经高亮可以选择了。

![image-20260523005836779](/images/posts/claude-code-permissions/image-20260523005836779.png)
